<?php
  ...
  if ($result->num_rows > 0) {
    ...
    echo '<html><head><title>Discounts</title>';
    ...
    echo '<h1>DISCOUNTS</h1>';
    echo '<h6 class="small"><strong>Printed On: </strong>' . $currentDateTime . '</h6>';
    echo '</div>';
    echo '</div>';
    echo '<table class="table table-bordered">';
    echo '<thead><tr><th>ID</th><th>Type</th><th>Percent</th><th>Validity</th></tr></thead>';
    echo '<tbody>';
    ...
    echo '<tbody>
            <tr>
              <td colspan="4" style="text-align:center;">0 Results</td>
            </tr>
          </tbody>';
    echo '</table><br><br>';

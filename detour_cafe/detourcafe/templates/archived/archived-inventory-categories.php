...
if (isset($_POST["delete_save"])) {
  ...
  // Delete the record
  $delete_query = "DELETE FROM archived_inventory_category WHERE ID = ?";
  $stmt = $conn->prepare($delete_query);
  $stmt->bind_param("i", $id);

  if ($stmt->execute()) {
      // Insert into archived_discounts
      $insert_query = "INSERT INTO db_inventory_category (category, type) VALUES (?, ?)";
...
$sql = 'SELECT * FROM archived_inventory_category';
...
<?php require_once '../navbar/header.php';?>
  ...
  <!-- Alerts will be inserted here -->
    ...
    <div class="pagetitle">
      ...
      <nav>
        <ol class="breadcrumb">
          <li class="breadcrumb-item active">Archived / Ingredient Categories <i class="bi bi-card-list"></i></li>
        </ol>
      </nav>
    </div><!-- End Page Title -->
    ...
    <section class="section">
        <div class="row">
          <div class="col-lg-12">
            ...
            <div class="card">
              <div class="card-body">
                  <h5 class="card-title">Inventory Categories
                  </h5>
